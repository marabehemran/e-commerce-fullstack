...
function ManageSubCategoryCard() {
  return (
    <tr className="border-b border-slate-100 dark:border-slate-800">
      <td className="px-5 py-4 font-black">هاتف</td>
      <td className="px-5 py-4 text-slate-500">Electronies</td>
      <td className="px-5 py-4">
        <div className="flex flex-wrap gap-2">
          <Link to="/manageupdatesubcategory">
